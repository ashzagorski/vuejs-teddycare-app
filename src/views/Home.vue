    ...
    <section>
      <div class="container">
        ...
        <div id="blog-homepage" class="row">
          <div class="col-md-6">
            <div class="post">
              <div align="middle" class="image"><a href="https://www.childrenshospitals.org/newsroom/childrens-hospitals-today/articles/2018/01/rounding-robots-connect-with-hospital-patients-and-staff"><img src="img/robots.jpg" alt="" class="img-fluid"></a></div>
              <h4><a href="https://www.childrenshospitals.org/newsroom/childrens-hospitals-today/articles/2018/01/rounding-robots-connect-with-hospital-patients-and-staff">Rounding Robots Connect with Hospital Patients and Staff</a></h4>
              ...
              <p class="read-more"><a href="https://www.childrenshospitals.org/newsroom/childrens-hospitals-today/articles/2018/01/rounding-robots-connect-with-hospital-patients-and-staff" class="btn btn-outline-white-primary">Continue reading</a></p>
            </div>
          </div>
          <div class="col-md-6">
            <div class="post">
