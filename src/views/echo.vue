<template>
  <div class="echo">
      ...
      <div class="container">
        <h1 class="heading">Echo Pain Assessment<br><small> <a href="#"> VISIT ID: {{visit_id}}</a></small></h1>
        <p style="text-align: center;">Utilize Echo the Teddy Bear to Complete Pain Assessment and when complete press complete button. </p>
...
export default {
  data: function() {
    return {
      ...
      patient_id: localStorage.patientId
    };
  },
  created: function() {},
  methods: {},
